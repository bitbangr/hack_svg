...
pub fn svg_1(){
    ...
    let _ = test_create_svg(op_svg_file_name,
        ...
        create_3x3_rgb_checker_tile_data);
} // svg1
...
pub fn svg_2(){
    ...
    let _ = test_create_svg(op_svg_file_name,
        ...
        tiles_per_pane_height,
        tiles_per_pane_width,
        create_black_center_cross_tile_data);
} // svg2
...
// ******************************************************
// ******************************************************
/// Make a 3x3 black center cross
/// 
fn create_black_center_cross_tile_data() -> Vec<Vec<(euclid::Box2D<i32, euclid::UnknownUnit>, RGB)>> {
...
fn create_svg3_data() -> Vec<Vec<(euclid::Box2D<i32, euclid::UnknownUnit>, RGB)>> {
    let mut result_window: Vec<Vec<(Box2D<i32>, RGB)>> = Vec::new();
    ...
    let top_left :(i32,i32) = (0,100);
    let bot_right:(i32,i32) = (100,200);
    let (tile_box, rgb): (Box2D<i32>, RGB) = create_tile(top_left, bot_right , RGB_BLUE);
    let _ = &pane_grid.push((tile_box, rgb));
...
// ******************************************************
// ******************************************************
/// Make a 3x3 mosaic of a single pane of all blue tiles
/// 
fn create_3x3_rgb_checker_tile_data() -> Vec<Vec<(euclid::Box2D<i32, euclid::UnknownUnit>, RGB)>> {
    let mut result_window: Vec<Vec<(Box2D<i32>, RGB)>> = Vec::new();
...
fn create_white_black_checkerboard_data() -> Vec<Vec<(euclid::Box2D<i32, euclid::UnknownUnit>, RGB)>> {
    ...
    // white tile
    // [(Box2D((0, 0), (100, 100)), RGB(u8,u8,u8)),
    let top_left :(i32,i32) = (0,0);
    let bot_right:(i32,i32) = (100,100);
    let (tile_box, rgb): (Box2D<i32>, RGB) = create_tile(top_left, bot_right ,RGB_WHITE);
    let _ = &pane_grid.push((tile_box, rgb));
